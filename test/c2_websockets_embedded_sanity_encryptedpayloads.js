  ...
  */
    ...
    try{
      ...
      eventEmitterClient.on('/e2e_test1/testsubscribe/data/event', {event_type:'set', count:1}, function(message){
        ...
        if (!e){
          ...
          socketClient.set('/e2e_test1/testsubscribe/data/event', {property1:'property1',property2:'property2',property3:'property3'}, null, function(e, result){
    ...
    try{
      ...
      socketClient.on('/e2e_test1/testsubscribe/data/event', {event_type:'set', count:1}, function(message){
        ...
        if (!e){
          ...
          //then make the change
          eventEmitterClient.set('/e2e_test1/testsubscribe/data/event', {property1:'property1',property2:'property2',property3:'property3'}, null, function(e, result){
            ////////////////////////////console.log('put happened - listening for result');
          });
  ...
  it('should search for a complex object', function(callback) {
    ...
    socketClient.set('/e2e_test1/testsubscribe/data/complex/' + test_path_end, complex_obj, null, function(e, put_result){
      ...
      socketClient.set('/e2e_test1/testsubscribe/data/complex/' + test_path_end + '/1', complex_obj, null, function(e, put_result){
        ...
        socketClient.get('/e2e_test1/testsubscribe/data/complex*', {criteria:criteria1, options:options1}, function(e, search_result){
          ...
          socketClient.get('/e2e_test1/testsubscribe/data/complex*', {criteria:criteria2, options:options2}, function(e, search_result){
  ...
  it('should delete some test data', function(callback) {
    ...
    try{
      ...
      socketClient.set('/e2e_test1/testsubscribe/data/delete_me', {property1:'property1',property2:'property2',property3:'property3'}, {noPublish:true}, function(e, result){
...
//  We set the listener client to listen for a PUT event according to a path, then we set a value with the publisher client.
  ...
  it('should get using a wildcard', function(callback) {
    ...
    socketClient.set('e2e_test1/testwildcard/' + test_path_end, {property1:'property1',property2:'property2',property3:'property3'}, null, function(e, insertResult){
      expect(e == null).to.be(true);
  ...
  it('the listener should pick up a single delete event', function(callback) {
    ...
    try{
        ...
        //We put the data we want to delete into the database
        socketClient.set('/e2e_test1/testsubscribe/data/delete_me', {property1:'property1',property2:'property2',property3:'property3'}, null, function(e, result){

          //////////////////console.log('did delete set');
          //path, event_type, count, handler, done
          //We listen for the DELETE event
          eventEmitterClient.on('/e2e_test1/testsubscribe/data/delete_me', {event_type:'remove', count:1}, function(eventData){
  ...
  it('should unsubscribe from an event', function(callback) {
    ...
    eventEmitterClient.on('/e2e_test1/testsubscribe/data/on_off_test', {event_type:'set', count:0}, function(message){
      ...
      eventEmitterClient.offPath('/e2e_test1/testsubscribe/data/on_off_test', function(e){
        ...
        function(e, listenerId){
          ...
          socketClient.set('/e2e_test1/testsubscribe/data/on_off_test', {property1:'property1',property2:'property2',property3:'property3'}, {}, function(e, setresult){
            if (e) return callback(new Error(e));
      ...
      eventEmitterClient.on('/e2e_test1/testsubscribe/data/off_all_test', {event_type:'set', count:0},
        ...
        function(e){
          ...
          eventEmitterClient.offAll(function(e){
            ...
            socketClient.set('/e2e_test1/testsubscribe/data/off_all_test', {property1:'property1',property2:'property2',property3:'property3'}, null, function(e, put_result){
              if (e) return callback(e);
