describe('d7_payload_transform', function () {
      ...
      service.create({
        ...
        services: {
          ...
          pubsub: {
            ...
            config:{
              incomingSpy:function(packet, next){
                __inMessages.push(packet);
                next();
              },
              outgoingSpy:function(packet, next){
                __outMessages.push(packet);
                next();
              },
              primus:{
                compression:true
  ...
  it('the publisher should set and get some data', function (callback) {

    try {
      var test_path_end = require('shortid').generate();

      publisherclient.set('/test1/set' + test_path_end, {
        property1: 'property1',
        property2: 'property2',
        property3: 'property3'
        ...
        publisherclient.get('/test1/set' + test_path_end, null, function (e, results) {

          expect(results.property1 == 'property1').to.be(true);

          console.log('__inMessages:::', JSON.stringify(__inMessages, null, 2));
          console.log('__outMessages:::', JSON.stringify(__outMessages, null, 2));
