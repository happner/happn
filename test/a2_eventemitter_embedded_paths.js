describe('a2_eventemitter_embedded_paths', function () {
  ...
  it('the publisher should set new data', function (callback) {
    ...
    try {
      ...
      publisherclient.set('a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/' + test_path_end, {
        property1: 'property1',
        property2: 'property2',
        property3: 'property3'
  ...
  it('should search for data with more than one wildcard', function (callback) {
    ...
    try {
      ...
      publisherclient.set('a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/wildcards/' + test_path_end, {
        property1: 'property1',
        property2: 'property2',
        property3: 'property3'
      }, {noPublish: true}, function (e, result) {
  ...
  it('should set data, and then merge a new document into the data without overwriting old fields', function (callback) {
    ...
    try {
      ...
      publisherclient.set('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/merge/' + test_path_end, {
        property1: 'property1',
        property2: 'property2',
        property3: 'property3'
      }, null, function (e, result) {
        ...
        publisherclient.set('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/merge/' + test_path_end, {property4: 'property4'}, {merge: true}, function (e, result) {
          ...
          publisherclient.get('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/merge/' + test_path_end, null, function (e, results) {
  ...
  it('should search for a complex object', function (callback) {
    ...
    publisherclient.set('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/complex/' + test_path_end, complex_obj, null, function (e, put_result) {
      ...
      publisherclient.set('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/complex/' + test_path_end + '/1', complex_obj, null, function (e, put_result) {
        expect(e == null).to.be(true);

        ////////////console.log('searching');
        publisherclient.get('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/complex*', {
          criteria: criteria1,
          options: options1
  ...
  it('should delete some test data', function (callback) {
    ...
    try {
      ...
      publisherclient.set('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/delete_me', {
        property1: 'property1',
        property2: 'property2',
        property3: 'property3'
      }, {noPublish: true}, function (e, result) {
        ...
        publisherclient.remove('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/delete_me', {noPublish: true}, function (e, result) {
  ...
  it('should tag some test data', function (callback) {
    ...
    publisherclient.set('/a2_eventemitter_embedded_paths/' + test_id + '/test/tag', {
      property1: 'property1',
      property2: 'property2',
      property3: 'property3'
    }, {noPublish: true}, function (e, result) {
      ...
      publisherclient.set('/a2_eventemitter_embedded_paths/' + test_id + '/test/tag', null, {
        tag: randomTag,
        merge: true,
        noPublish: true
      }, function (e, result) {
    ...
    try {
      ...
      listenerclient.on('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/event', {
        ...
        if (!e) {
          ...
          //then make the change
          publisherclient.set('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/event', {
            property1: 'property1',
            property2: 'property2',
            property3: 'property3'
          }, null, function (e, result) {
...
//We are testing pushing a specific value to a path which will actually become an array in the database
  ...
  it('the publisher should push a sibling and get all siblings', function (callback) {
    ...
    try {
      ...
      publisherclient.setSibling('a2_eventemitter_embedded_paths/' + test_id + '/siblings/' + test_path_end, {
        ...
        publisherclient.setSibling('a2_eventemitter_embedded_paths/' + test_id + '/siblings/' + test_path_end, {
          ...
          publisherclient.get('a2_eventemitter_embedded_paths/' + test_id + '/siblings/' + test_path_end + '/*', null, function (e, getresults) {
            expect(e == null).to.be(true);
...
//  We set the listener client to listen for a PUT event according to a path, then we set a value with the publisher client.
  ...
  it('should get using a wildcard', function (callback) {
    ...
    publisherclient.set('a2_eventemitter_embedded_paths/' + test_id + '/testwildcard/' + test_path_end, {
      property1: 'property1',
      property2: 'property2',
      property3: 'property3'
    }, null, function (e, insertResult) {
      expect(e == null).to.be(true);
      publisherclient.set('a2_eventemitter_embedded_paths/' + test_id + '/testwildcard/' + test_path_end + '/1', {
        property1: 'property1',
        property2: 'property2',
        property3: 'property3'
      }, null, function (e, insertResult) {
        ...
        publisherclient.get('a2_eventemitter_embedded_paths/' + test_id + '/testwildcard/' + test_path_end + '*', null, function (e, results) {
  ...
  it('should get paths', function (callback) {
    ...
    publisherclient.set('a2_eventemitter_embedded_paths/' + test_id + '/testwildcard/' + test_path_end, {
      ...
      publisherclient.set('a2_eventemitter_embedded_paths/' + test_id + '/testwildcard/' + test_path_end + '/1', {
        ...
        publisherclient.getPaths('a2_eventemitter_embedded_paths/' + test_id + '/testwildcard/' + test_path_end + '*', function (e, results) {
  ...
  it('the listener should pick up a single delete event', function (callback) {
    ...
    publisherclient.set('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/delete_me', {
      ...
      listenerclient.on('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/delete_me', {
        event_type: 'remove',
        count: 1
      }, function (eventData) {
        ...
        //We perform the actual delete
        publisherclient.remove('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/delete_me', null, function (e, result) {
      ...
      listenerclient.offPath('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/on_off_test', function (e) {
        ...
        listenerclient.on('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/on_off_test', {
          ...
          function (e, listenerId) {
            ...
            publisherclient.set('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/on_off_test', {
              property1: 'property1',
              property2: 'property2',
              property3: 'property3'
  ...
  it('should subscribe to the catch all notification', function (callback) {
    ...
    listenerclient.onAll(function (eventData, meta) {
      ...
      publisherclient.set('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/catch_all', {
        ...
        publisherclient.remove('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/catch_all', null, function (e, del_result) {
      ...
      listenerclient.on('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/off_all_test', {
        ...
        function (e) {
          ...
          listenerclient.offAll(function (e) {
            ...
            publisherclient.set('/a2_eventemitter_embedded_paths/' + test_id + '/testsubscribe/data/off_all_test', {
              property1: 'property1',
              property2: 'property2',
              property3: 'property3'
            }, null, function (e, put_result) {
