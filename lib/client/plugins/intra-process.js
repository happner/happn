...
module.exports = {
	...
	set: Promise.promisify(function(path, data, parameters, handler){
		...
		if (path.indexOf('/test/a9-api-data') > -1){
			console.log('in intra-proc set:::',arguments);
			console.log('in set handler:::',handler.toString());
		}
	...
	on: Promise.promisify(function(path, parameters, handler, done){
		...
		if (path.indexOf('/test/a9-api-data') > -1){
			console.log('in intra proc on:::',arguments);
			console.log('in on handler:::',handler.toString());
		}
