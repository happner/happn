(function () { // begin enclosed
  ...
  HappnClient.prototype.handle_response_array = function (e, response, meta) {
    ...
    response.map(function(item){
      responseArray.push(_this.__formatResponse(item));
    });

    responseHandler.handleResponse(e, responseArray);

  };

  HappnClient.prototype.__formatResponse = function(response){

    //make the _meta data non-enumerable
    var _meta = response._meta;
  ...
  HappnClient.prototype.handle_response = function (e, response) {
    ...
    if (responseHandler) {
      ...
      responseHandler.handleResponse(e, this.__formatResponse(response));
    }
