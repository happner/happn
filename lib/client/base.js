...
HappnClient.prototype.handle_publication = function(message){
	...
	if (message.__ARRAY) {
		...
		message = message.__ARRAY;
	}

	if (message._event.type == 'data'){
	  	this.handle_data(message._event.channel, message);
  	}else if (message._event.type == 'message'){
  		this.handle_message(message);
  	}else if (message._event.type == "response"){
