function HappnClient(options, initializedCallback){
	...
	_this.checkPath = function(path){
		...
		if (path.match(/^[a-zA-Z0-9//_*/-]+$/) == null)
			throw new Error('Bad path, can only contain alphanumeric chracters, forward slashes, underscores, a single wildcard * and minus signs ie: /this/is/an/example/of/1/with/an/_*-12hello');
	};
