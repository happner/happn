...
SecurityUsers.prototype.initialize = Promise.promisify(function (config, securityService, callback) {
  ...
  try {
    ...
    _this.cacheService =  _this.securityService.happn.services.cache;
    _this.dataService =  _this.securityService.dataService;
    //backward compatible for allowing mongo plugin, which uses an actual path field
    _this.pathField = _this.dataService.pathField;
    _this.utilsService =  _this.securityService.happn.services.utils;
    _this.errorService =  _this.securityService.happn.services.error;
    _this.cryptoService =  _this.securityService.cryptoService;
