...
SecurityService.prototype.serialize = function(objectType, obj, options){
    ...
    if (options.deepCopy){
        return _this.happn.utils.clone(returnObj);
    }else
        return returnObj;
}
...
SecurityService.prototype.getGroup = function(groupName, options, callback){
    ...
    try{
        ...
        if (cachedGroup) return callback(null, _this.happn.utils.clone(cachedGroup));
        ...
        _this.dataService.get(searchPath, {sort:"_id"}, function(e, result){
            ...
            if (result){
                ...
                __groupCache.set(groupName, _this.happn.utils.clone(group));
