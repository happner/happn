...
SecurityService.prototype.initialize = function(config, done){
    try{
        ...
        if (config.webAuthorize != undefined && !config.webAuthorize)
            config.webAuthorize = function(req, res, next){
                next();
            }
...
SecurityService.prototype.webAuthorize = function(req, res, next){
