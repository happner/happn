...
SecurityService.prototype.createAuthenticationNonce = function(request, callback){
  ...
  //made this async because we may have an async cache later
  ...
  this.__authenticationNonceCache[nonce] = request;

  callback(null, generateNonce);

//__authenticationNonceCache
};
