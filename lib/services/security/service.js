...
SecurityService.prototype.__upsertUser = function(user, options, callback){
    ...
    _this.generateHash(user.password, function(e, hash){
        ...
        var upsertUser = JSON.parse(JSON.stringify(user));
        upsertUser.password = hash;

        _this.dataService.upsert(userPath, upsertUser, {merge:true}, function(e, result){
            if (e) return callback(e);
    ...
    try{
        _this.dataService.remove(deletePath, {}, function(e, groupDeleteResults){
            ...
            _this.dataService.remove(deletePath, {}, function(e, userGroupDeleteResults){
                ...
                __groupCache.del(group.username);
