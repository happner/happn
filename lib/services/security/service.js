...
SecurityService.prototype.initialize = function(config, done){
    try{
        ...
        this.pubsubService = this.happn.services.pubsub;
        ...
        _this._ensureKeyPair(config, function(e){
            ...
            _this._ensureAdminUser(config, function(e){
                ...
                _this.checkpoint.initialize(config, _this, done);
...
SecurityService.prototype.login = function(credentials, callback) {
    ...
    if (credentials.username && credentials.password) {
        ...
        return _this.getUser(credentials.username, {includePassword:true}, function(e, user){
            ...
            if (e) return callback(e);
            if (user == null) return callback(_this.AccessDeniedError());

            console.log('verifying user:::', credentials, user);

            _this.verifyHash(credentials.password, user.password, function(e, match) {

                if (e) return callback(e);

                if (!match) return callback(_this.AccessDeniedError());
        ...
        _this.validate('user', options, user, function(e) {
            ...
            _this.generateHash(user.password, function(e, hash){
                ...
                _this.dataService.upsert(userPath, user, {merge:true}, function(e, result){
                    ...
                    _this.checkpoint.manifestChanged('upsert-user', upserted);
...
SecurityService.prototype.deleteUser = function(user, options, callback) {
    ...
    _this.dataService.remove(userPath, {}, function(e, result1){
        ...
        _this.dataService.remove(userTree, {}, function(e, result2){
            ...
            _this.checkpoint.manifestChanged('delete-user', deleted);
    ...
    try{
        _this.validate('group', options, group, function(e){
            ...
            _this.dataService.upsert(groupPath, group, {merge:true}, function(e, result){
                ...
                _this.checkpoint.manifestChanged('upsert-group', upserted);
                callback(null, upserted);
    ...
    try{
        _this.dataService.remove(deletePath, {}, function(e, groupDeleteResults){
            ...
            _this.dataService.remove(deletePath, {}, function(e, userGroupDeleteResults){
                ...
                _this.checkpoint.manifestChanged('delete-group', deleted);
    ...
    try{
        ...
        _this.dataService.get(searchPath, {sort:"_id"}, function(e, results){
            ...
            if (results.length > 0){
                ...
                if (returnUser && !options.includePassword)
    ...
    try{
        _this.validate('user-group', [group, user], options, function(e){
            ...
            _this.dataService.upsert(groupLinkPath, options, {merge:true}, function(e, result){
                ...
                _this.checkpoint.manifestChanged('link-group', upserted);
                callback(null, upserted);
    ...
    try{
         _this.validate('user-group', [group, user], null, function(e){
            ...
            _this.dataService.remove(groupLinkPath, {}, function(e, result){
                ...
                _this.checkpoint.manifestChanged('unlink-group', groupLinkPath);
...
SecurityService.prototype.authorize = function(session, path, action, callback){
    console.log('going to checkpoint:::', this.checkpoint);
    this.checkpoint.authorize(session, path, action, callback);
}
