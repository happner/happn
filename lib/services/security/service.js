...
SecurityService.prototype.__loginFailed = function(username, callback){
  ...
  if (_this.config.accountLockout && _this.config.accountLockout.enabled) {
...
SecurityService.prototype.login = function (credentials, callback) {
  ...
  if (_this.__checkLockedOut(credentials.username)) return callback(_this.AccessDeniedError('Account locked out'));
