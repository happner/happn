    ...
    try{
        ...
        _this._ensureKeyPair(config, function(e){
            ...
            _this._ensureAdminUser(config, function(e){
                ...
                _this.checkpoint.initialize(config, _this.dataService, _this.pubsubService, done);
...
SecurityService.prototype.generatePermissionSetKey = function(session){
    return Object.keys(session.data.groups).reduce(function(key, groupName){
...
SecurityService.prototype.login = function(credentials, callback) {
    ...
    if (credentials.username && credentials.password) {
        ...
        return _this.getUser(credentials.username, {includePassword:true}, function(e, user){
            ...
            if (e) return callback(e);
            if (user == null) return callback(new AccessDenied());

            _this.verifyHash(credentials.password, user.data.password, function(e, match) {
