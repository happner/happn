...
SecurityService.prototype.__initializeSessionManagement = function(config, callback){
  ...
  this.activateSessionManagement(callback);

};

SecurityService.prototype.activateSessionManagement = function(callback){
  var _this = this;
...
SecurityService.prototype.__cache_revoked_sessions = null;
SecurityService.prototype.__cache_session_activity = null;
SecurityService.prototype.__cache_active_sessions = null;
...
SecurityService.prototype.revokeSession = function(sessionId, reason, callback){
  ...
  this.__cache_revoked_sessions.set(sessionId, {reason:reason}, callback);
};
...
SecurityService.prototype.__listCache = function(cacheName, filter, callback){
  ...
  this[cacheName].all(function(e, allItems){
    ...
    try{
      if (filter) allItems = sift(filter, allItems);
