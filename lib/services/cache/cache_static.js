...
StaticCache.prototype.update = function(key, data, callback){
...
StaticCache.prototype.increment = function(key, by, callback){
...
StaticCache.prototype.clear = function(callback){
  this.__cache = {};
...
StaticCache.prototype.get = function(key, opts, callback){
...
StaticCache.prototype.set = function(key, data, opts, callback){
  try{
...
StaticCache.prototype.all = function(callback){
  ...
  try{
    ...
    Object.keys(this.__cache).forEach(function(itemKey){
      allItems.push(utilities.clone(this.__cache[itemKey].data));
    }.bind(this));
...
StaticCache.prototype.remove = function(key, opts, callback){
