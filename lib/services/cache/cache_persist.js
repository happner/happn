...
PersistedCache.prototype.update = function(key, data, callback){
...
PersistedCache.prototype.increment = function(key, by, callback){
...
PersistedCache.prototype.clear = function(callback){
...
PersistedCache.prototype.get = function(key, opts, callback){
...
PersistedCache.prototype.sync = function(callback){
...
PersistedCache.prototype.set = function(key, data, opts, callback){
  try{
    ...
    var cacheItem = {data:utilities.clone(data), key:key};
...
PersistedCache.prototype.remove = function(key, opts, callback){
...
PersistedCache.prototype.all = function(callback){
  ...
  var returnAll = function(){
    ...
    Object.keys(_this.__cache).forEach(function(itemKey){
      allItems.push(utilities.clone(_this.__cache[itemKey].data));
    });
