...
ProtocolService.prototype.processMessageIn = function(message, respond){
  ...
  if (message.raw.protocol.indexOf('happn') == 0) protocol = _this.config.protocols['happn'];
  else protocol = _this.config.protocols[message.raw.protocol];

  console.log('doing waterfall:::');
