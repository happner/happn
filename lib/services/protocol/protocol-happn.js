...
ProtocolHappn.prototype.success = function(message, callback){
  callback(null, this.__createResponse(null, message.request, message.response, message.opts));
};
...
ProtocolHappn.prototype.fail = function(e, message, callback){
  ...
  callback(null, this.__createResponse(e, message.request, message.response, message.opts));
};
