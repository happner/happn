...
ProtocolHappn.prototype.validate = function(message){
  ...
  try{
    ...
    if (['on', 'get', 'set', 'off', 'remove', 'describe', 'emit'].indexOf(message.request.action) == -1) throw _this.happn.services.error.ValidationError('Unknown request action: ' + message.request['action']);
...
ProtocolHappn.prototype.success = function(message){
  ...
  return new Promise(function(resolve, reject) {
    ...
    try{
      var resolution = resolve(_this.__createResponse(null, message.request, message.response, message.opts));
...
ProtocolHappn.prototype.fail = function(e, message){
  ...
  return new Promise(function(resolve, reject) {
    ...
    try{
      ...
      resolve(null, _this.__createResponse(e, message.request, message.response, message.opts));
