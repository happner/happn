...
//
//   if (!audienceGroup || audienceGroup[channel] == null) return;
//
//   console.log('have audience group:::', audienceGroup, channel);
//
//   var audienceSessions = this.getAudienceSessions(audienceGroup[channel], opts);
//
//   console.log('have audience sessions:::', audienceSessions);
//
//   if (audienceSessions.length == 0) return;
//
//   var decoupledPublication, socket;
//
//   for (var sessionIndex in audienceSessions) {
//
...
//
//     console.log('writing publication:::', decoupledPublication);
...
PubSubService.prototype.emitToAudience = function (publication, channel, opts) {
  ...
  if (audienceGroup[channel] != null && audienceGroup[channel] != undefined) {
    ...
    console.log('audienceGroup[channel]:::', audienceGroup[channel]);
