...
LocalClient.prototype.end = function(data, opts){

  if (data != null) {
    data.__outbound = true;
    this.write(data);
  }
...
LocalClient.prototype.end = function(data, options){
  this.__closed = true;
  this.emit('end', data);
};

LocalClient.prototype.destroy = function(data, options){
  this.__closed = true;
