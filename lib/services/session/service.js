...
SessionService.prototype.__safeSessionData = function(sessionData){
  ...
  var safeSessionData = {
    ...
    "encrypted": sessionData.encrypted?true:false,
...
SessionService.prototype.each = function(eachHandler, callback){
  ...
  async.each(sessionKeys, function(sessionKey, sessionKeyCallback){
    ...
    _this.__session_info.get(sessionKey, function(e, sessionData){
      ...
      if (sessionData) eachHandler.call(eachHandler, sessionData, function(e, update){
...
SessionService.prototype.disconnect = function (client, reason) {
  ...
  _this.__session_info.get(client.sessionId, function(e, sessionData) {
    ...
    _this.happn.services.queue.pushInbound({raw:{action:'disconnect', data:reason}, session:sessionData})
      ...
      .then(function(){
        ...
        _this.__session_info.remove(client.sessionId, function(e){
          ...
          _this.happn.services.queue.pushOutbound(_this.__disconnectMessage(client, reason))
