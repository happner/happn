...
SessionService.prototype.handleMessage = Promise.promisify(function (message, client) {
  ...
  _this.happn.services.queue.pushInbound({raw:message, sessionId:client.sessionId})
...
SessionService.prototype.disconnect = function (client) {
  ...
  _this.happn.services.queue.pushInbound({raw:{action:'disconnect'}, sessionId:client.sessionId})
