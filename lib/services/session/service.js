...
SessionService.prototype.handleMessage = Promise.promisify(function (message, client) {
  ...
  _this.happn.services.queue.push({request:message, sessionId:client.sessionId})
    .then(function(processed){
      console.log('have success:::', processed);
      client.write(processed.response);
    })
    .catch(function(e, failed){
      console.log('internal failure:::', e);
      _this.happn.services.error.handleSystem.call(_this.happn.services.error, e, failed);
    });
});
...
SessionService.prototype.disconnect = function (client) {
  ...
  _this.happn.queue.push({request:{action:'disconnect'}, sessionId:client.sessionId})
    .then(function(){
