...
SessionService.prototype.handleMessage = function (message, client) {
  this.happn.queue.push({request:message, sessionId:client.sessionId})
    .then(function(response){
      client.write(response);
    })
    .catch(this.happn.error.system)
};
