...
SystemService.prototype.getDescription = function(){
    ...
    return {
        name:_this.name,
        secure:_this.happn.config.secure?true:false,
        encryptPayloads:_this.happn.config.encryptPayloads?true:false,
        publicKey:_this.happn.config.secure?_this.happn.services.security._keyPair.publicKey:null
    }
}
